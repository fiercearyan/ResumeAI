...
import { FileText, Briefcase, LayoutDashboard, LogOut, Moon, Sun, Send } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      <aside className="w-60 border-r flex flex-col">
        ...
        <nav className="px-3 space-y-1">
          ...
          <div
            className="flex items-center gap-2 px-3 py-2 rounded-md text-sm text-muted-fg cursor-not-allowed opacity-60"
            title="Auto-apply ships in Phase 3"
          >
            <Send size={16} /> Auto-apply <span className="ml-auto text-xs">Phase 3</span>
          </div>
        </nav>
